...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String injectedJS =
            ...
            "document.querySelectorAll('[class*=block],[class*=Block],[class*=banner],[class*=Banner],[class*=popup],[class*=Popup],[class*=overlay],[class*=cookie-notice],[class*=gdpr]').forEach(function(el){" +
